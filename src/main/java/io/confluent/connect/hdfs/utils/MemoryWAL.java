...
public class MemoryWAL implements WAL {
  ...
  private static Map<String, List<Object>> data = new HashMap<>();
  ...
  public MemoryWAL(String topicsDir, TopicPartition topicPart, Storage storage, HdfsSinkConnectorConfig conf)
          throws ConnectException {
    this(topicsDir, topicPart, storage);
  }
