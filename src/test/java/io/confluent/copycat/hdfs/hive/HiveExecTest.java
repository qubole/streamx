...
import io.confluent.copycat.hdfs.HdfsSinkConnectorTestBase;
import io.confluent.copycat.hdfs.HdfsWriter;
...
public class HiveExecTest extends HdfsSinkConnectorTestBase {
  ...
  public void testAvroTableImport() throws Exception {
    Schema avroSchema = avroData.fromCopycatSchema(createSchema());
  ...
  public void testAlterSchema() throws Exception {
    ...
    Schema newAvroSchema = avroData.fromCopycatSchema(createNewSchema());
  ...
  private void prepareData(String topic, int partition) throws Exception {
    ...
    String key = "key";
    org.apache.kafka.copycat.data.Schema schema = createSchema();
    Struct record = createRecord(schema);

    Collection<SinkRecord> sinkRecords = new ArrayList<>();
    for (long offset = 0; offset < 7; offset++) {
      SinkRecord sinkRecord =
          new SinkRecord(topic, partition, org.apache.kafka.copycat.data.Schema.STRING_SCHEMA, key,
